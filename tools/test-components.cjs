...
const CASES = [
  ...
  ["InfoBox", { children: "هشدار", tone: "warn" }],
  ["Collapse", { title: "جزئیات فنی", children: "بدنه" }],
  ["Collapse", { title: "باز", open: true, children: "بدنه" }],
  ["MiniMarkdown", { text: ["### Fixed", "- **یک** مورد با `code`", "- دومی", "", "پاراگراف"].join("\n") }],
  ["MiniMarkdown", { text: "" }],
  ["StatusChip", { ok: true }],
