...
# بخشی از هارنس از خروجیِ واقعیِ بکند روی فیکسچرِ موقت ساخته می‌شود؛
# مسیرِ فایلِ موقت (C:\Users\<نام>\AppData\...، /tmp/...) همراهش می‌آمد
# و در صفحه‌ی تنظیماتِ حسابداری نشسته بود. مخزن عمومی است.
